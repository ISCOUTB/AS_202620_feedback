...
Buen avance en la entrega: el contrato OpenAPI 3.1 versión 1.0.0 está en el repositorio con rutas y esquemas de datos, el ADR de integración justifica la opción síncrona frente a las alternativas descartadas, y la sección 6 de arc42 describe los flujos de registro, login y tareas. Para que el informe pueda cerrar los criterios que quedaron abiertos, conviene publicar: (1) el contenido de docs/c4/C4-C2.md con cada flecha etiquetada con protocolo y formato; (2) el fragmento del workflow donde se invoca la prueba de contrato y la URL del run; (3) el análisis en SonarCloud con Quality Gate y su URL pública para el commit revisado; (4) el historial de git del archivo de contrato. Sobre la prueba de contrato, además de la auto-prueba en memoria, un run en rojo ante un cambio incompatible real deja la evidencia visible en el pipeline. La tabla de aspectos debe poder leerse completa, con sus ocho columnas navegables. La nota final la fija el docente en Moodle.
